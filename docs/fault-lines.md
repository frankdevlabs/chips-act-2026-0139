# Fault lines — the contested issues

> The issues likely to dominate negotiation, each linked to its [`provisions/`](provisions/) page.
> At this stage (proposal tabled, no co-legislator position) these are **projected** fault lines from
> the 2023 Chips Act's negotiation history, early analyses and stakeholder reactions — expectation,
> not fact. Recalibrate once Council/EP texts exist.

- **The financing gap** — the proposal's only quantified new expenditure is ~EUR 70m for the B2B
  Supply Chain Platform; Initiative 2.0 rides on existing Horizon Europe/Digital Europe budgets, and
  the strategic-project money is deferred to the (un-agreed) next MFF and the proposed European
  Competitiveness Fund. **Caveat:** the investment figures circulating in secondary reporting
  (~€120bn for chips, ~€30bn for the open foundry) are **indicative and not confirmed in the
...
- **Open-foundry feasibility and state aid** ([strategic-projects-open-foundry](provisions/strategic-projects-open-foundry.md)) —
  ...
  national first-of-a-kind aid. Whether a leading-edge-node + chiplet + 3D-packaging facility with
  pilot production "envisaged 2030–2033" is commercially realistic — and who the operator and
...
- **Scope of crisis-stage powers** ([crisis-response](provisions/crisis-response.md)) — mandatory
  ...
  of the 2023 Chips Act, and return strengthened (third-country order pass-through, B2B Platform
  obligations). Council activation by QMV (Art 39) keeps Member States in control of the trigger,
  but industry will again push for narrower duties and clearer compensation; watch confidentiality
  and the penalty ceilings.
- **Demand-side instruments' bite** ([chips-initiative-demand](provisions/chips-initiative-demand.md)) —
  Demand Accelerators and the Demand Forum are run by the Industrial Alliance with no purchase
  obligations; the procurement lever (Arts 30–32) is largely optional for contracting authorities
  ("may require" a security-of-supply declaration) until the Commission hardens it by implementing
