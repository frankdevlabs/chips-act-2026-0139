...
| **As of** | **19 August 2026** (= `data/tracker-state.yaml` `last_run`) |
...
[ST 10094/26](sources/README.md)), while Parliament has not yet referred it to committee — no
co-legislator position of any kind exists yet.
