...
| **OLP stage** | 1st reading — **proposal tabled**; Council at working-party start (COMPET.1 routing), Parliament in committee (**referred to ITRE 14 Sep 2026**, rapporteur appointed); **no general approach, no trilogue** |
...
> COM(2026) 504 in [`extracts/commission/`](extracts/commission/) — working transcriptions, verify
> against the committed proposal PDF before relying on them.

## One-line status

Chips Act 2.0 was tabled on 3 June 2026 as one of the two legislative halves of the Tech Sovereignty
Package (together with CADA, file 2026/0138 — tracked elsewhere); it repeals and replaces the 2023
European Chips Act (Regulation (EU) 2023/1781). The Council received it on 3 June (cover note
[ST 10094/26](sources/README.md)); Parliament referred it to committee (ITRE lead) on 14 September
2026 and has appointed a rapporteur, but no co-legislator position of any kind exists yet.
...
- **Latest act:** Package-level policy debate "Technological Sovereignty" at the formal Telecom Council, 9 June 2026 — ministers **welcomed the package**; no Chips-Act-specific commitments — [timeline](TIMELINE.md) · [main results (IEU mirror)](https://ieu-monitoring.com/editorial/main-results-of-the-eu-telecommunications-council-on-9-june-2026/1243080)
- **Owner:** Cyprus Presidency (until 30 June 2026), then Ireland (from 1 July 2026)
- **Position:** No formal position — no Presidency compromise text, no general approach; 27 Member States signed the Semicon Coalition Declaration calling for a Chips Act 2.0 (29 September 2025), signalling broad baseline support
...
- **Stage:** Committee stage — **committee referral announced in Parliament (1st reading) on 14 September 2026**; ITRE responsible; awaiting committee decision (no draft report tabled yet)
- **Latest act:** Committee referral announced 14 Sep 2026 — [Oeil](https://oeil.europarl.europa.eu/oeil/en/procedure-file?reference=2026/0139(COD)) · [Legislative Train "Chips Act II"](https://www.europarl.europa.eu/legislative-train/theme-a-new-plan-for-europe-s-sustainable-prosperity-and-competitiveness/file-chips-act-ii)
- **Owner:** **ITRE (lead)** — rapporteur **Oliver Schenk (EPP)**, appointed 31 Aug 2026; shadows László András (PfE), Francesco Torselli (ECR), Bart Groothuis (Renew), Virginijus Sinkevičius (Greens/EFA). Opinion committees: **IMCO**; **JURI** (rapporteur Maravillas Abadía Jover (EPP), appointed 23 Jun 2026); **BUDG** decided not to give an opinion. (Names/dates per [Oeil](https://oeil.europarl.europa.eu/oeil/en/procedure-file?reference=2026/0139(COD)) — verify against the live page)
- **Position:** None yet; no draft report or committee opinions tabled — early individual reactions only (see [stakeholders](docs/stakeholders.md) for MEP comments)
- **Next:** ITRE draft report and opinion-committee (IMCO/JURI) draft opinions; then tabled amendments
...
- [x] **EP committee referral + rapporteur** — referred to **ITRE** (lead), referral announced 14 Sep 2026; rapporteur **Oliver Schenk (EPP)** appointed 31 Aug 2026; IMCO + JURI opinions, BUDG none ([Oeil](https://oeil.europarl.europa.eu/oeil/en/procedure-file?reference=2026/0139(COD)))
- [ ] **ITRE draft report** on Chips Act 2.0 (and IMCO/JURI draft opinions) — first EP operative text; would trigger the `extracts/parliament/` layer
...
- [ ] Indicative political-agreement window **~Q2 2027** per the Joint Roadmap "One Europe, One Market" — political planning, not a legal deadline
- [ ] Watch-item: the **open foundry strategic project (Art 19)** and the investment figures circulating in secondary reporting (e.g. ~€120bn chips investment, ~€30bn foundry) — treat as indicative until confirmed in SWD(2026) 504/the financing instruments

<!-- "What changed in the latest text vs earlier reporting" intentionally omitted: only the Commission
     proposal exists; nothing has diverged yet. Add the section (and docs/what-changed.md) with the first
     Council compromise text or EP draft report. -->
